      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {similarAds.map((ad) => (
          ...
          >
            ...
            {/* Ad Details */}
            <div className="p-3 flex-1 flex flex-col justify-between min-h-[128px]">
              {/* Title */}
              <div>
                <h3 className="font-bold text-sm sm:text-base text-gray-900 break-words leading-tight">
                  {ad.title.length > 35
                ...
                {ad.tag !== "free" && (
                  <div className="flex items-center gap-1">
                    <a
                      ...
                      className="bg-green-600 text-white px-2 py-1.5 rounded-md hover:bg-green-700 transition-colors flex-1 flex items-center justify-center text-xs font-medium"
                      title="WhatsApp"
                    >
                      <svg
                    ...
                    <a
                      ...
                      className="bg-blue-600 text-white px-2 py-1.5 rounded-md hover:bg-blue-700 transition-colors flex-1 flex items-center justify-center text-xs font-medium"
                      title="Call"
                    >
                      <svg
                        className="h-3 w-3 mr-1"
